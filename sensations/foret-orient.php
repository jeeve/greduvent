                ...
                <div class="col-xs-12 col-sm-12 col-md-9 fond">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 fond">
                            <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d37879.67679584464!2d4.314305791208331!3d48.27260803932337!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1614520706100!5m2!1sfr!2sfr"
                                    width="600" height="450" style="border:0;" allowfullscreen=""
                                    loading="lazy"></iframe>
                            </div>
                            <p class="legende">Le spot sur <a
                                    href="https://mywindsessions.com/mws_new/detail_spot.php?id_spot=276"
                                    target="_blank">My
                                    wind session</a></p>
                        </div>
                        ...
                        <div class="hidden-xs col-sm-8" style="margin-left: 5px;">
                            <div class="fond-table encadrement-table" style="width: 540px;">
                                <div style="width:520px;overflow:auto;">
                                    ...
                                    <iframe align="top"
                                        src="https://widgets.windalert.com/widgets/web/modelTable?spot_id=33113&units_wind=kph&units_temp=C&type=daily&width=5830&height=310&color=f1eeee&amp;name=Lac d Orient&app=windalert"
                                        width="5830" height="310" frameborder="0" scrolling="no"
                                        allowtransparency="no"></iframe>
                                </div>
                                <script type="text/javascript"
                                    src="https://www.windfinder.com/widget/forecast/js/lac-de-la-foret-d-orient?unit_wave=m&unit_rain=mm&unit_temperature=c&unit_wind=kts&days=4&show_day=1&show_pressure=0&show_waves=0">
                                </script><noscript><a rel='nofollow'
                                        href='https://www.windfinder.com/forecast/lac-de-la-foret-d-orient?utm_source=forecast&utm_medium=web&utm_campaign=homepageweather&utm_content=noscript-forecast'>Wind
                                        forecast for Lac de la Forêt d'Orient<a> provided by <a rel='nofollow'
                                ...
                                (function(window, document) {
                                    var loader = function() {
                                        var arg = ["s=92534", "m=3", "uid=wg_fwdg_92534_100_1614521312463",
                        ...
                        <div class="hidden-xs col-sm-2" style="margin-left: 65px;">
                            <div class="fond-table encadrement-table" style="width: 150px;">
                                <p>
                                    ...
                                    <a href="https://www.ventusky.com/fr/48.249;4.334"
                                        target="_blank">Ventusky</a><br><br>
                                    <a href="https://www.xcweather.co.uk/forecast/mesnil_saint_pere"
                    ...
                    <div class="row histo">
                        ...
                        <div class="col-xs-12 col-sm-10 fond" id="historique-niveau-foretorient"></div>
                    </div>
                    <div class="row histo">
                        <div class="col-sm-1 fond"></div>
                    ...
                    <div id="swipe">
                        ...
                        <div class="row">
                            <p class="numero-page">page 14i</p>
