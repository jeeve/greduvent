...
-->
                    ...
                    <div class="row histo">
                        ...
                        <div class="col-xs-12 col-sm-10 fond" id="historique-vent-poses"></div>
                    </div>
                    <div class="row histo">
                        <div class="col-sm-2 fond"></div>
                        <div class="col xs-12 col-sm-8 fond" id="historique-rose-poses"></div>
                    </div>
					<div class="row histo">
                        <div class="col-sm-1 fond"></div>
                        <div class="col-xs-12 col-sm-10 fond" id="historique-temp-poses"></div>
                    </div>
                    <br><br>
