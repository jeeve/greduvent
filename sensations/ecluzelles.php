...
<body>
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 fond">
                                            ...
                                            <tr>
                                                <td colspan=2>
                                                    <p style="font-size: 10px;">Données temps réel <em><a
                                                                ...
                                                                href="https://openweathermap.org/city/3020810"
                                                                target="_blank">Dreux</a></em></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                        ...
                        <div class="hidden-xs col-sm-8" style="margin-left: 5px;">
                            <div class="fond-table encadrement-table" style="width: 540px;">
                                <script type="text/javascript"
                                    src="https://fr.windfinder.com/widget/forecast/js/ecluzelles?unit_wave=m&unit_rain=mm&unit_temperature=c&unit_wind=kts&days=4&show_day=1&show_pressure=0&show_waves=0">
                        ...
                        <div class="hidden-xs col-sm-2" style="margin-left: 65px;">
                            <div class="fond-table encadrement-table" style="width: 150px;">
                                <p>
                                    ...
                                    <a href="https://www.ventusky.com/?p=48.70;1.31;8&l=wind-10m"
                                        target="_blank">Ventusky</a><br><br>
                                    <a href="https://www.xcweather.co.uk/forecast/ecluzelles"
                    ...
                    <div class="row">
                        <div class="visible-xs col-xs-12 fond">
                            <div class="fond-table encadrement-table">
                                ...
                                <a href="https://fr.windfinder.com/weatherforecast/ecluzelles" target="_blank"><img
                                        src="images/logo-windfinder.png" alt="superforecast" title="superforecast"></a>
                                <a href="https://www.windguru.cz/919254" target="_blank"><img
                                        src="images/logo-windguru.gif"></a>
                                <a href="https://www.ventusky.com/?p=48.70;1.31;8&l=wind-10m" target="_blank"><img
                                        src="images/logo-ventusky.png"></a>
                                <a href="https://www.xcweather.co.uk/forecast/ecluzelles" target="_blank"><img
                    ...
                    <form id="datetimeform">
                        ...
                        <div>
                            <p><label for="ma-date">Date </label><input style="width: 130px;"
                                    id="ma-date-ecluzelles" type="text" name="date" value="25/02/2017"></input></p>
                        </div>
                        <!-- 
    ...
    function maPosition(position) {
        ...
        var itineraireSrc =
            'https://www.google.com/maps/embed?pb=!1m22!1m8!1m3!1d671697.5903318735!2d1.6982330023342986!3d48.883217929654236!3m2!1i1024!2i768!4f13.1!4m11!3e0!4m3!3m2!1d' +
            lat1 + '!2d' + lon1 + '!4m5!';
        jQuery('#map-ecluzelles').attr('src', itineraireSrc +
            '1s0x47e6aa6bfb177b91%3A0x40dc8d705397b20!2sM%C3%A9zi%C3%A8res-en-Drouais%2C%2028500!3m2!1d48.726036!2d1.4259739999999999!5e0!3m2!1sfr!2sfr!4v1592896527904!5m2!1sfr!2sfr'
            );
    }
