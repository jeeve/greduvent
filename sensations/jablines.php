...
<head>
    ...
    <META NAME="Description"
        CONTENT="La base de loisir de Jablines avec webcam, archives, météo en temps réel et prévisions, lien vers les forums." />
                                                ...
                                                <tr>
                                                    <td colspan=2>
                                                        <p style="font-size: 10px;">Données temps réel <em><a
                                                                    ...
                                                                    href="https://openweathermap.org/city/2972444"
                                                                    target="_blank">Torcy</a></em></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                        ...
                        <div class="hidden-xs col-sm-8" style="margin-left: 5px;">
                            <div class="fond-table encadrement-table" style="width: 540px;">
                                <div style="width:520px;overflow:auto;"><iframe align="top"
                                        src="https://widgets.windalert.com/widgets/web/modelTable?spot_id=33136&amp;units_wind=kts&amp;units_temp=C&amp;type=daily&amp;width=5830&amp;height=310&amp;color=f1eeee&amp;name=Vaires-sur-Marn&amp;app=windalert"
...
-->
                        ...
                        <div class="hidden-xs col-sm-2" style="margin-left: 65px;">
                            <div class="fond-table encadrement-table" style="width: 150px;">
                                <p>
                                    ...
                                    <a href="https://www.ventusky.com/?p=48.78;2.64;8&l=wind-10m"
                    ...
                    <div class="row">
                        <div class="visible-xs col-xs-12 fond">
                            <div class="fond-table encadrement-table">
                                ...
                                <a href="https://www.ventusky.com/?p=48.78;2.64;8&l=wind-10m" target="_blank"><img
                    ...
                    <form id="datetimeform">
                        ...
                        <div>
                            <p><label for="ma-date" style="margin-right: 10px;">Date </label><input style="width: 130px;"
                                    id="ma-date-jablines" type="text" name="date" value="25/02/2017"></input></p>
                        </div>
                        <!-- 
                    ...
                    <div class="row histo">
                        ...
                        <div class="col-xs-12 col-sm-10 fond" id="historique-vent-jablines"></div>
                    </div>
                    <div class="row histo">
                        <div class="col-sm-2 fond"></div>
                        <div class="col xs-12 col-sm-8 fond" id="historique-rose-jablines"></div>
                    </div>
					<div class="row histo">
                        <div class="col-sm-1 fond"></div>
                        <div class="col-xs-12 col-sm-10 fond" id="historique-temp-jablines"></div>
                    </div>
                    <br><br>
    ...
    */
    ...
    function maPosition(position) {
        ...
        var itineraireSrc =
            ...
            lat1 + '!2d' + lon1 + '!4m5!';
        jQuery('#map-jablines').attr('src', itineraireSrc +
            '1s0x47e61c3ceabfc0ff%3A0x40b82c3688c57b0!2sJablines!3m2!1d48.917429!2d2.761107!5e0!3m2!1sfr!2sfr!4v1544557168668'
            );
    }
