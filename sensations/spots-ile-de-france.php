...
<head>
    ...
    <META NAME="Description"
        CONTENT="Où naviguer en Ile-de-France. Les spots de la région parisienne pour la planche à voile, le windsurf et le windfoil. Prévisions, météo temps réel et webcams." />
                                ...
                                <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                    <div id="page">
                                        <iframe width="650" height="450"
                                            src="https://embed.windy.com/embed2.html?lat=48.669&lon=2.340&zoom=7&level=surface&overlay=wind&menu=&message=true&marker=&calendar=&pressure=&type=map&location=coordinates&detail=&detailLat=49.013&detailLon=2.005&metricWind=kt&metricTemp=%C2%B0C&radarRange=-1"
...
-->
                        ...
                        <div class="col-sm-4">
                            <div class="fond-table encadrement-table liste-spots">
                                <a href="https://docs.google.com/spreadsheets/d/1O3WDo7864s7npqM7r7zd2XXVWeVqhuqjgmzfObh40gY/edit?usp=sharing"
                                    target="_blank">
                                    <h2 id="titre-spots">Spots</h2>
                                </a>
                                <div id="menu-vent">
                                    <SELECT>
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td>
                                            <p><a href="#moisson">Moisson Lavacourt</a></p>
                                        </td>
                                        <td>
                                            <p class="noteMoisson"></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><a href="#ecluzelles">Mézières-Écluzelles</a></p>
                                        </td>
                                        <td>
                                            <p class="noteEcluzelles"></p>
                                        </td>
                                    </tr>
                                    <!--	<tr><td><p><a href="#saint-quentin">Saint-Quentin en Y.</a></p></td><td><p class="noteSaintQuentin"></p></td></tr>					-->
                                    <tr>
                                        <td>
                                            <p><a href="#jablines">Jablines</a></p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="noteGrandeParoisse"></p>
                                        </td>
                                    </tr>
                                    <!--	<tr><td colspan="2"><p>Plus loin...</p></td></tr> -->
                                    <tr>
                                        <td>
                                            <p><a href="#foret-orient">Forêt d'Orient</a> (<span
                                                    class="niveau-foret-orient"></span> %)</p>
                                        </td>
                                        <td>
                                            <p class="noteForetOrient"></p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div id="boutons-deplier-replier">
                                    <p>
                                        <button onclick="clickDeplier()">Tout déplier</button> <button
                                            onclick="clickReplier()">Tout replier</button>
                                    </p>
                                </div>
                                <!--
						<div id="comparer">
                    ...
                    <br>
                    <a name="poses"></a>
                    <h2><input id="div-poses" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-poses" /> <a href="lery-poses.php">Léry-Poses</a></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" value="Orientations" data-target="#item-vue-poses"
                                    ...
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-poses"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button" data-target="#item-histo-poses"
                                            value="Histo" class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-poses" class="collapse">
                                    <a href="images/spots-lery-poses.jpg" target="_blank">
                                        <img src="images/spots-lery-poses-2.jpg" width=400
...
-->
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="fond-table encadrement-table" style="width: 150px;">
                                    <p>
                                        ...
                                        <a href="https://meteofrance.com/previsions-meteo-france/val-de-reuil/27100"
                    ...
                    <a name="moisson"></a>
                    <h2><input id="div-moisson" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-moisson" /> <a href="moisson.php">Moisson Lavacourt</a></h2>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-moisson"
                                    ...
                                    -
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-moisson"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-moisson" value="Histo" class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-moisson" class="collapse">
                                    <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15691.154105754329!2d1.674180497185694!3d49.05563923112997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1546124769919"
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=581", "m=3", "uid=wg_fwdg_581_3_1544556198330",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
...
-->
                                ...
                                <div class="fond-table encadrement-table" style="width: 150px;">
                                    <p>
                                        <a href="https://fr.windfinder.com/weatherforecast/moisson_lavacourt"
                                            target="_blank">Superforecast</a><br><br>
                                        <a href="https://meteofrance.com/previsions-meteo-france/moisson/78840"
                                            target="_blank">Météo France</a><br><br>
                    ...
                    <a name="ecluzelles"></a>
                    <h2><input id="div-moisson" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-ecluzelles" /> <a href="ecluzelles.php">Mézières-Écluzelles</a></h2>
                    <div id="item-div-ecluzelles" class="collapse in">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-ecluzelles"
                                        ...
                                        class="btn-releve" />--> - <span class="hidden-xs"><input type="button"
                                            ...
                                            class="btn-releve" /></span>
                                    -
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-ecluzelles"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-ecluzelles" value="Histo"
                                            class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-ecluzelles" class="collapse">
                                    <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d11077.639428984821!2d1.4224061084166975!3d48.7148328689713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1589917230536!5m2!1sfr!2sfr"
                                            width="600" height="450" frameborder="0" style="border:0;"
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=919254", "m=3", "uid=wg_fwdg_919254_3_1589916450009",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="fond-table encadrement-table" style="width: 150px;">
                                    <p>
                                        <a href="https://fr.windfinder.com/weatherforecast/ecluzelles"
                                            target="_blank">Superforecast</a><br><br>
                                        <a href="https://meteofrance.com/previsions-meteo-france/ecluzelles/28500"
                                            target="_blank">Météo France</a><br><br>
...
-->
                    ...
                    <a name="jablines"></a>
                    <h2><input id="div-jablines" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-jablines" /> <a href="jablines.php">Jablines</a></h2>
                    <div id="item-div-jablines" class="collapse in">

                        <div class="row">
                            <div class="col-sm-8">

                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-jablines"
                                        value="Satellite" class="btn-releve" /> - <input type="button"
                                        data-toggle="collapse" data-target="#item-webcam-jablines" value="Webcam"
                                        class="btn-releve" /> - <span class="hidden-xs"><input type="button"
                                            data-target="#item-infos-jablines" value="Informations"
                                            class="btn-releve" /></span><span class="visible-xs-inline"><input
                                            type="button" data-target="#item-infos-jablines" value="Infos"
                                            class="btn-releve" /></span>
                                    -
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-jablines"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-jablines" value="Histo"
                                            class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-jablines" class="collapse">
                                    <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d13272.819129650208!2d2.7189477352299387!3d48.91141958867993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1546124228312"
                                            width="600" height="450" frameborder="0" style="border:0"
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=60274", "m=3", "uid=wg_fwdg_90210_3_1538749208510",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
                    ...
                    <div id="item-div-vaires" class="collapse in">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-vaires"
                                        value="Satellite" class="btn-releve" /> - <input type="button"
                                        data-toggle="collapse" data-target="#item-webcam-vaires" value="Webcam"
                                        class="btn-releve" /> - <span class="hidden-xs"><input type="button"
                                            data-target="#item-infos-vaires" value="Informations"
                                            class="btn-releve" /></span><span class="visible-xs-inline"><input
                                            type="button" data-target="#item-infos-vaires" value="Infos"
                                            class="btn-releve" /></span>
                                    -
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-vaires"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-vaires" value="Histo" class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-vaires" class="collapse">
                                    <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d11109.004540217287!2d2.619497111646004!3d48.864038185964624!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1546124922241"
                                            width="600" height="450" frameborder="0" style="border:0"
                                            allowfullscreen></iframe>
                                    </div>
                                    <br>
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=60276", "m=3", "uid=wg_fwdg_60276_3_1544556036427",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
...
-->
                    ...
                    <h2><input id="div-grande-paroisse" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-grande-paroisse" /> <a href="grande-paroisse.php">La
                            Grande-Paroisse</a></h2>
                    <div id="item-div-grande-paroisse" class="collapse in">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-grandeparoisse"
                                        value="Satellite" class="btn-releve" /> - <input type="button"
                                        data-toggle="collapse" data-target="#item-webcam-grandeparoisse" value="Webcam"
                                        class="btn-releve" /> - <span class="hidden-xs"><input type="button"
                                            data-target="#item-infos-grandeparoisse" value="Informations"
                                            class="btn-releve" /></span><span class="visible-xs-inline"><input
                                            type="button" data-target="#item-infos-grandeparoisse" value="Infos"
                                            class="btn-releve" /></span>
                                    -
                                    <span class="hidden-xs"><input type="button"
                                            data-target="#item-histo-grandeparoisse" value="Historique"
                                            class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-grandeparoisse" value="Histo"
                                            class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-webcam-grandeparoisse" class="collapse">
                                    <div class="embed-responsive embed-responsive-16by9 ombre-image webcam">
                                        ...
                                        <video id="video-grande-paroisse" class="vjs-tech" tabindex="-1" preload="auto"
                                            loop="" muted="muted" playsinline="playsinline" autoplay=""></video>
                                        <div class="webcam-texte">
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=90210", "m=3", "uid=wg_fwdg_90210_3_1546091535290",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
...
-->
                    ...
                    <h2><input id="div-foret-orient" type="button" value=" - " data-toggle="collapse"
                            data-target="#item-div-foret-orient" /> <a href="foret-orient.php">La Forêt d'Orient</a>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <p><input type="button" data-toggle="collapse" data-target="#item-vue-foretorient"
                                    ...
                                    - <span class="hidden-xs"><input type="button" data-target="#item-infos-foretorient"
                                        ...
                                        class="visible-xs-inline"><input type="button"
                                            data-target="#item-infos-foretorient" value="Infos"
                                            class="btn-releve" /></span>
                                    -
                                    <span class="hidden-xs"><input type="button" data-target="#item-histo-foretorient"
                                            value="Historique" class="btn-releve" /></span>
                                    <span class="visible-xs-inline"><input type="button"
                                            data-target="#item-histo-foretorient" value="Histo"
                                            class="btn-releve" /></span>
                                </p>
                                ...
                                <div id="item-vue-foretorient" class="collapse">
                                    <div class="embed-responsive embed-responsive-4by3 ombre-image">
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d45080.63704030345!2d4.33706154791041!3d48.27179599100967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sforet%20orient!5e1!3m2!1sfr!2sfr!4v1600861587932!5m2!1sfr!2sfr"
                                            width="600" height="450" frameborder="0" style="border:0;"
                                            allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                                    </div>
                                    <br>
                                ...
                                <div class="fond-table encadrement-table">
                                    ...
                                    (function(window, document) {
                                        var loader = function() {
                                            var arg = ["s=92534", "m=3", "uid=wg_fwdg_92534_3_1600861761128",
                                                "wj=knots", "tj=c", "odh=7", "doh=21", "fhours=240",
                                                "vt=forecasts",
                                                "p=WINDSPD,GUST,MWINDSPD,SMER,TMPE,FLHGT,CDC,APCPs,RATING"
                                            ];
...
-->
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="fond-table encadrement-table" style="width: 150px;">
                                    <p>
                                        <a href="https://www.windfinder.com/weatherforecast/lac-de-la-foret-d-orient"
                                            target="_blank">Superforecast</a><br><br>
                                        <a href="https://meteofrance.com/previsions-meteo-france/mesnil-saint-pere/10140"
                                            target="_blank">Météo France</a><br><br>
...
-->
                    ...
                    <div class="row">
                        <div class="col-xs-12 fond">
                            ...
                            <h2>Commentaires</h2>
                            <p>
                                <a href="https://goo.gl/forms/ZlDIbV7DJhXjArND3" target="_blank">Poster un commentaire
                    ...
                    <div id="swipe">
                        <div class="row">
                            <div class="col-xs-5">
                                <p><a href="sensations.php">sensations</a> - <a id="page-precedente"
                                        href="glisse.php">glisse</a></p>
                            </div>
                            <div class="col-xs-7">
