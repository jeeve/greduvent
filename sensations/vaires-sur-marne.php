...
<head>
    ...
    <META NAME="Description"
        CONTENT="La base de Vaires sur Marne avec webcam, archives, météo en temps réel et prévisions, lien vers les forums." />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 fond">
                            ...
                            <p class="legende">Le spot sur <a
                                    href="https://mywindsessions.com/mws_new/detail_spot.php?id_spot=254"
...
-->
                    ...
                    <form id="datetimeform">
                        ...
                        <div>
                            <p><label for="ma-date" style="margin-right: 10px;">Date </label><input style="width: 130px;"
                                    id="ma-date-vaires" type="text" name="date" value="25/02/2017"></input></p>
                        </div>
                        <!-- 
    ...
    function maPosition(position) {
        ...
        var itineraireSrc =
            ...
            lat1 + '!2d' + lon1 + '!4m5!';
        jQuery('#map-vaires').attr('src', itineraireSrc +
            '1s0x47e61074aa8587ab%3A0x40b82c3688c48d0!2sVaires-sur-Marne!3m2!1d48.873608999999995!2d2.6395429999999998!5e0!3m2!1sfr!2sfr!4v1544557341867'
            );
    }
