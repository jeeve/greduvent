      <div class="navbar navbar-default navbar-fixed-top" role="navigation">
          <div class="container">
              ...
              <button id="bouton-bas-page" type="button" class="navbar-toggle hidden" style="padding-top:5px;"
                  data-toggle="bas-page" data-target=".sidebar-nav">
                  <span style="float: left; margin-right: 10px" class="hidden-xs">
                      <font color="grey" style="font-family: 'Raleway', sans-serif;">bas de page</font>
                  </span>
                  <span class="glyphicon glyphicon-arrow-down" style="color: grey; padding-top: 3px;"></span>
              </button>
              <button id="bouton-haut-page" type="button" class="navbar-toggle hidden"
                  style="padding-bottom:5px; padding-top:5px" data-toggle="offcanvas" data-target=".sidebar-nav">
                  <span style="float: left; margin-right: 10px" class="hidden-xs">
                      <font color="grey" style="font-family: 'Raleway', sans-serif;">haut de page</font>
                  </span>
