...
<body>
    ...
    <div id="lecteur">
        <div id="player">
            ...
            <button type="button" id="BtnShuffle" class="btn btn-default btn-lg active" data-attr="shuffled"
        ...
        <div class="containerPlayer">
            <div>
                <ul id="playListContainer">
                    ...
                    <li data-src="songs/vol-au-dessus-d-un-champ-de-salicornes.mp3"><a href="#">Vol au-dessus d'un champ
                            de salicornes</a></li>
        ...
        <div style="position: absolute; left: 250px">
            <a target="_blank" href="https://www.youtube.com/playlist?list=PLvp4urJ2GQfiRa0B5ZYjLukDXRb4fA4zr"><img
                    title="Cuisine Spectrale" border="0" src="images/cuisinespectralemini.png" width="50"
                    height="50"></a>
        </div>
    </div>
